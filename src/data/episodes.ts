...
// Mock episode data — replace with API calls when ready
export const episodes: Episode[] = [
  {
    ...
    category: "transformation", episodeNumber: 47, thumbnail: "/src/assets/thumb-transform.jpg",
    youtubeId: "dQw4w9WgXcQ", views: 124000, publishedAt: "2026-03-01",
    beforeImage: "/src/assets/before-piece.jpg", afterImage: "/src/assets/after-piece.jpg",
  ...
  },
  {
    ...
    category: "thrift-hunt", episodeNumber: 46, thumbnail: "/src/assets/thumb-hunt.jpg",
  ...
  },
  {
    ...
    category: "giveaway", episodeNumber: 45, thumbnail: "/src/assets/thumb-giveaway.jpg",
  ...
  },
  {
    ...
    category: "transformation", episodeNumber: 44, thumbnail: "/src/assets/thumb-reveal.jpg",
    youtubeId: "dQw4w9WgXcQ", views: 87000, publishedAt: "2026-02-08",
    beforeImage: "/src/assets/before-piece.jpg", afterImage: "/src/assets/featured-drop.jpg",
  ...
  },
  {
    ...
    category: "livestream", episodeNumber: 43, thumbnail: "/src/assets/thumb-transform.jpg",
  ...
  },
  {
    ...
    category: "transformation", episodeNumber: 42, thumbnail: "/src/assets/thumb-reveal.jpg",
  ...
  },
  {
    ...
    category: "thrift-hunt", episodeNumber: 41, thumbnail: "/src/assets/thumb-hunt.jpg",
  ...
  },
  {
    ...
    category: "studio", episodeNumber: 40, thumbnail: "/src/assets/thumb-transform.jpg",
    youtubeId: "dQw4w9WgXcQ", views: 61000, publishedAt: "2026-01-11",
  },
];

export const shortVideos: ShortVideo[] = [
  { id: "s1", title: "30-second thrift find", thumbnail: "/src/assets/short-1.jpg", youtubeId: "dQw4w9WgXcQ" },
  { id: "s2", title: "Quick frame transformation", thumbnail: "/src/assets/short-2.jpg", youtubeId: "dQw4w9WgXcQ" },
  { id: "s3", title: "$1 bowl becomes art", thumbnail: "/src/assets/short-1.jpg", youtubeId: "dQw4w9WgXcQ" },
  { id: "s4", title: "The reveal moment", thumbnail: "/src/assets/short-2.jpg", youtubeId: "dQw4w9WgXcQ" },
  { id: "s5", title: "Studio time-lapse", thumbnail: "/src/assets/short-1.jpg", youtubeId: "dQw4w9WgXcQ" },
  { id: "s6", title: "Painting in real time", thumbnail: "/src/assets/short-2.jpg", youtubeId: "dQw4w9WgXcQ" },
];
...
export const livestreamEvents: LivestreamEvent[] = [
  {
    ...
    scheduledAt: "2026-03-15T14:00:00Z", isLive: false, isReplay: false,
    thumbnail: "/src/assets/thumb-hunt.jpg",
  },
  {
    ...
    scheduledAt: "2026-03-22T18:00:00Z", isLive: false, isReplay: false,
    thumbnail: "/src/assets/thumb-transform.jpg",
  },
  {
    ...
    scheduledAt: "2026-03-29T19:00:00Z", isLive: false, isReplay: false,
    thumbnail: "/src/assets/thumb-giveaway.jpg",
  },
  {
    ...
    scheduledAt: "2026-02-01T18:00:00Z", youtubeId: "dQw4w9WgXcQ", isLive: false, isReplay: true,
    thumbnail: "/src/assets/thumb-transform.jpg",
  },
];
