...
const About = () => (
  <div className="min-h-screen bg-[#F9F6F0]">
    ...
    <section className="container py-16 md:py-24 max-w-3xl">
      ...
      <h1 className="font-heading text-4xl md:text-5xl uppercase tracking-tighter text-stone-950 leading-[0.9] mb-8">
        From Forgotten
        <br />
      ...
      <div className="space-y-6 text-stone-600 text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-stone-300 my-10">
          {[
            ...
            <div key={p.label} className={`p-4 ${i < 3 ? "border-r border-stone-300" : ""}`}>
              <h3 className="font-heading text-[10px] uppercase tracking-wider text-orange-800 mb-1">{p.label}</h3>
