...
const FourPillars = () => (
  <div className="space-y-3">
    ...
    <div className="grid grid-cols-4 gap-0 border border-stone-300">
      {pillars.map(({ icon: Icon, label, desc, detail }, i) => (
        ...
        >
          <Icon size={20} className="text-orange-800 mb-2" />
          <span className="font-heading text-[10px] uppercase tracking-wider text-stone-950 mb-0.5">
            {label}
          </span>
