          ...
          {steps.map((step, i) => (
            <div key={step.label} className="flex items-center">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 md:w-16 md:h-16 border-3 border-stone-400 flex items-center justify-center bg-white rotate-1 hover:-rotate-1 transition-transform">
