...
const SiteFooter = () => {
  return (
    <footer className="relative py-14 md:py-20 bg-grunge film-grain border-t border-stone-800 overflow-hidden">
      ...
      <div className="absolute right-6 top-1/2 -translate-y-1/2 text-primary-foreground z-[2]">
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <p className="font-sans font-bold text-xs uppercase tracking-[0.2em] text-stone-400 mb-3">Explore</p>
          ...
          <div>
            <p className="font-sans font-bold text-xs uppercase tracking-[0.2em] text-stone-400 mb-3">Connect</p>
            <div className="space-y-2">
