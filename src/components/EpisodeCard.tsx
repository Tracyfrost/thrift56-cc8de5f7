  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden">
        ...
        <span className={`absolute top-3 left-3 px-2 py-0.5 text-[10px] font-heading uppercase tracking-wider rounded-sm ${categoryColors[episode.category] || "bg-muted text-muted-foreground"}`}>
